...
export default {
    ...
    methods:{
        deleteImage(event, img, index){
            ...
            // var slide_top = event.target.parentNode.parentNode.parentNode.parentNode;
            // slide_top.remove();
            // var test = '<div class="swiper-container oflow-visible" data-slide-effect="flip" data-autoheight="false" data-wheel-control="true" data-swiper-speed="200" data-swiper-margin="25" data-swiper-slides-per-view="1" data-swiper-breakpoints="true" data-scrollbar="true" data-swiper-loop="false" data-swpr-responsive="[1, 2, 1, 2]"><div class="swiper-wrapper"><div class="img-fluid swiper-slide"><div style="text-align:right; background-color:black;"><i @click="deleteImage($event, img, index)" class="icon-close text-white"></i></div><div class="normal"><img src="./theme/images/ai.jpg"  class="img-fluid"></div></div><div class="img-fluid swiper-slide"><div style="text-align:right; background-color:black;"><i @click="deleteImage($event, img, index)" class="icon-close text-white"></i></div><div class="normal"><img src="./theme/images/ai.jpg"  class="img-fluid"></div></div><div class="img-fluid swiper-slide"><div style="text-align:right; background-color:black;"><i @click="deleteImage($event, img, index)" class="icon-close text-white"></i></div><div class="normal"><img src="./theme/images/ai.jpg"  class="img-fluid"></div></div></div><div class="swiper-pagination"  slot="pagination"></div><div class="swiper-button-prev" slot="button-prev"></div><div class="swiper-button-next" slot="button-next"></div></div>'
        ...
        searchLocation(){
            ...
            const url = "http://192.168.100.48:5000/location/"+keyword;
